...
public boolean isManager() {
        return role.contains("Bank Manager");
    }
    
    //User implementation of role Bank Employee
public boolean isEmployee() {
        return role.contains("Bank Employee");
}

   //User implementation of role Administrator
...
public boolean isCustomer() {
   ...
   //User implementation of role Advisor
public boolean isAdvisor() {
        return role.contains("Advisor");
}
